...
const Footer = memo(() => {
  ...
  return (
    <footer className="relative tt5 bg-red-200 overflow-hidden rrr rrCenter w-[96vw] text-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4 transform hover:scale-105 transition-all duration-500 group">
            ...
            {/* <div className="flex space-x-2 opacity-0 group-hover:opacity-100 transition-all duration-500">
              ...
              <Star className="w-4 h-4 text-yellow-500 animate-pulse delay-100" />
              <Star className="w-4 h-4 text-yellow-500 animate-pulse delay-200" />
              <Star className="w-4 h-4 text-yellow-500 animate-pulse delay-300" />
              <Star className="w-4 h-4 text-yellow-500 animate-pulse delay-400" />
            </div> */}
          </div>
